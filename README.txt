An auto-clicker with a maximum CPS of 10, made for 1.8.9

Default Keybinds:

* R - Toggle on/off autoclicker
* RShift - Open settings GUI
...
* Action bar status - displays active state + cps setting (server action bars have priority)
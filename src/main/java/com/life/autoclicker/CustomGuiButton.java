...
public class CustomGuiButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + 1, borderColor); // Top
        drawRect(this.xPosition, this.yPosition + this.height - 1, this.xPosition + this.width, this.yPosition + this.height, borderColor); // Bottom
        drawRect(this.xPosition, this.yPosition, this.xPosition + 1, this.yPosition + this.height, borderColor); // Left
        drawRect(this.xPosition + this.width - 1, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, borderColor); // Right
